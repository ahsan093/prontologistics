					...
					<div class="col-sm-4">
						...
						<div class="adress-details wow fadeInLeft" data-wow-delay="0.3s">
							<div>
								...
								<div><strong>Pronto Logistics Ltd.</strong><br>Sifa Towers, Kilimani,Ring Road </div>
							</div>
							<div>
								<span><i class="fa fa-phone"></i></span>
								<div>+1 4432516617 </div>
							</div>
							<div>
								<span><i class="fa fa-envelope"></i></span>
								<div>support@prontotech.us</div>
							</div>
							<div>
						...
						<div class="adress-details wow fadeInLeft" data-wow-delay="0.3s">
							<div>
								<span><i class="fa fa-location-arrow"></i></span>
								<div><strong>Pronto Logistics Ltd.</strong><br>507 MAIN ST, #01 EAST ROCHESTER<br>New York, NY, 14445, USA<br>United States</div>
							</div>
							<div>
								<span><i class="fa fa-phone"></i></span>
								<div>+1 4432516617 </div>
