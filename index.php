...
<?php include 'header.php' ?>			
	        ...
	        <div id="owl-main-slider" class="owl-carousel enable-owl-carousel" data-single-item="true" data-pagination="false" data-auto-play="true" data-main-slider="true" data-stop-on-hover="true">
                ...
                <div class="item">
            		<img src="media/3-column-info/3.jpg" alt="slider">
	                <div class="container-fluid">
	                    <div class="slider-content col-md-6 col-lg-6">
	                        <div style="display:table;">
	                            <div style="display:table-cell; width:100px; vertical-align:top;">
	                            ...
	                            <div style="display:table-cell;">
	                                <h1>GROUND SHIPPING</h1>
	                            </div>
	                        </div>
	                        <p>We provide a comprehensive transportation network for all your ground shipping needs.<br><a class="btn btn-success" href="#">LEARN MORE</a></p>
	                    </div>
	                </div>
	            </div>
                 <div class="item">
	                ...
	                <div class="container-fluid">
	                    <div class="slider-content col-md-6 col-lg-6">
	                        <div style="display:table;">
	                            ...
	                            <div style="display:table-cell;">
	                                <h1>GOODS SHIPPING</h1>
	                            </div>
	                        </div>
	                        <p>We are able to offer coverage on goods shipping and also assist in interconnections of trucking schedules for Transit Cargo.<br><a class="btn btn-success" href="#">LEARN MORE</a></p>
	                    </div>
	                </div>
	            </div>
                <div class="item">
	        ...
	        <div class="container-fluid">
        		<div class="row column-info block-content">
	                ...
	                <div class="col-sm-4 col-md-4 col-lg-4 wow fadeInRight" data-wow-delay="3.3s">
	                    ...
	                    <span></span>
	                    <h3>GROUND SHIPPING</h3>
	                    <p>We provide a comprehensive transportation network for all your ground shipping needs.</p>
	                    <a class="btn btn-default btn-sm" href="road-trucking.php">READ MORE</a>
	                </div>
	            </div>
	        </div>
	        ...
	        <div class="big-hr color-1 wow zoomInUp" data-wow-delay="0.3s">
        		<div class="text-left" style="margin-right:40px;">
            		...
            		<p>Pronto Logistics is a well-established supply chain solution's firm majoring in logistics and consultancy.</p>
				</div>
				...
				<div class="row our-services">
            		<div class="col-sm-6 col-md-4 col-lg-4 wow zoomInLeft" data-wow-delay="0.3s">
                		<a href="clearance.php">
	                        ...
	                        <p>Pronto Logistics has wide experience in handling Imports and Exports in Kenya, South Sudan and other </p>
	                    </a>
	                </div>
	                ...
	                <div class="col-sm-6 col-md-4 col-lg-4 wow zoomInRight" data-wow-delay="0.3s">
                		<a href="supply-chain-management.php">
                            ...
                            <p>Pronto Logistics is capable of assisting reviewing procurement organizations for best practices and </p>
	                    </a>
	                </div>
	            </div>
	        </div>
