					...
					<div class="col-sm-9">
						<div class="row services">
							<div class="service-item col-xs-6 col-sm-4 col-md-4 col-lg-4 wow zoomIn" data-wow-delay="0.3s">
								...
								<p>Customs clearance, rules and processes can be confusing but our goal is to make customs brokerage as easy as possible.</p>
							...
							<div class="service-item col-xs-6 col-sm-4 col-md-4 col-lg-4 wow zoomIn" data-wow-delay="0.3s">
								...
								<p>Pronto Logistics has wide experience in handling Imports and Exports in Kenya, South Sudan and other adjoining COMESA countries.</p>
							...
							<div class="service-item col-xs-6 col-sm-4 col-md-4 col-lg-4 wow zoomIn" data-wow-delay="0.3s">
								...
								<p>Pronto Logistics is capable of assisting and reviewing procurement organizations for best practices and supply chain solutions.</p>
